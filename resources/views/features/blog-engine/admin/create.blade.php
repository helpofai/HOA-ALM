...
<form action="{{ route('admin.blog.store') }}" method="POST" enctype="multipart/form-data" id="blog-form" class="w-full max-w-5xl mx-auto rounded-[2.5rem] bg-white/5 border border-white/5 backdrop-blur-md p-8 animate-fade-in relative overflow-hidden">
    @csrf
    ...
    <div class="space-y-8">
        ...
        <div class="pt-6 border-t border-white/5 flex justify-end gap-4">
            <a href="{{ route('admin.blog.index') }}" data-navigate class="px-6 py-3 rounded-xl bg-white/5 text-text-main text-sm font-bold border border-white/10 hover:bg-white/10 transition-colors">Cancel</a>
