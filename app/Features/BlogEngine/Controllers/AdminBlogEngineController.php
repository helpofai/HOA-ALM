...
class AdminBlogEngineController extends Controller
{
    /**
     * Display a listing of ALL blog posts for the admin.
     */
    public function index()
    {
        $posts = BlogEnginePostModel::with('author')->orderBy('created_at', 'desc')->paginate(10);
        return view('features.blog-engine.admin.index', compact('posts'));
    }
    ...
    public function create()
    {
        ...
        return view('features.blog-engine.admin.create', compact('categories'));
    }
